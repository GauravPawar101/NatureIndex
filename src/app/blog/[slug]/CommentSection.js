    ...
    <form onSubmit={handleSubmit} className="mt-4">
      ...
      <div className="flex justify-between items-center mt-3">
        <input 
          ...
          className="text-sm text-gray-300 file:mr-2 file:py-1 file:px-3 file:rounded-full file:border-0 file:text-xs file:font-semibold file:bg-white file:text-black hover:file:bg-gray-200 file:cursor-pointer" 
        />
        <div className="flex items-center gap-2">
          ...
          <button 
            ...
            className="px-4 py-2 bg-white text-black rounded-full font-semibold disabled:opacity-50 hover:bg-gray-200 transition-all"
          >
      ...
      <div className="flex-grow">
        ...
        {comment.image_url && (
          <a href={comment.image_url} target="_blank" rel="noopener noreferrer">
            <div className="mt-3 relative w-full max-w-xs h-48 rounded-lg overflow-hidden border border-white/20 hover:border-white/40 transition-colors">
        ...
        {comment.replies && comment.replies.length > 0 && (
          <div className="pl-6 mt-4 pt-4 space-y-4 border-l-2 border-white/20">
  ...
  return (
    <div className="mt-16 pt-8 border-t border-white/10">
      <h2 className="text-3xl font-bold text-white mb-2">
        Discussion
        <span className="text-gray-400 ml-2 font-normal text-xl">({comments.length})</span>
      </h2>
